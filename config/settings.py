...
# === Ensemble Thresholds (Optimized for Hybrid Decision) ===
ENSEMBLE_SAFE_THRESHOLD = 40.0
ENSEMBLE_PHISHING_THRESHOLD = 60.0

# === Metadata Card Thresholds (Calibrated for XGBoost) ===
METADATA_URL_SAFE_THRESHOLD = 54.54
METADATA_URL_PHISHING_THRESHOLD = 85.45

# === Layer 2 / Risk Scoring ===
NEW_DOMAIN_THRESHOLD_DAYS = 30
DOMAIN_INTEL_CACHE_PATH = FEATURES_DIR / "domain_age_cache.json"
LAYER1_MAX_RISK_POINTS = 55
LAYER2_MAX_RISK_POINTS = 45
LAYER3_MAX_RISK_POINTS = 100
